      ...
      children: [
        Consumer<LibraryScreenLogic>(
          builder: (context, logic, child) {
            ...
            if (logic.currentCollection == 'All') {
              filteredBooks = logic.addedBooks;
            } else {
              filteredBooks =
                  logic.collectionBooks[logic.currentCollection] ?? [];
            }
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                String bookName = filteredBooks[index];
                print('Book in current collection: $bookName'); // debug print
